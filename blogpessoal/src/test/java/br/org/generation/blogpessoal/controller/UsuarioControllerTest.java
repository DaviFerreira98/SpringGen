...
public class UsuarioControllerTest {
	...
	@Test
	@Order(1)
	@DisplayName("🤷‍♂️🤷‍ Cadastrar um Usuario")
	...
	@Test
	@Order(2)
	@DisplayName("🤦‍♂️🤦‍♂️‍‍ Não Deve Permitir Duplicação do Usuario")
	...
	public void deveAtualizarUmUsuario() {
		Optional<Usuario> create = usuarioService.cadastrarUsuario(new Usuario(0L,
				"Juliana Andrews", "juliana_andrews@email.com.br", "juliana123"));
		Usuario usuarioUpdate = new Usuario(create.get().getId(), 
	...
	@Test
	@Order(4)
	@DisplayName("👼🕵️‍♀️‍‍ Listar todos os Usuario")
